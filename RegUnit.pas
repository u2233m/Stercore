...
begin
  if Edit1.Text='' then
    begin
      Application.MessageBox('Не заполнено поле: Фамилия','Ошибка ввода',MB_OK);
      Edit1.SetFocus;
      exit;
    end;
  if Edit2.Text='' then
    begin
      Application.MessageBox('Не заполнено поле: Имя','Ошибка ввода',MB_OK);
      Edit2.SetFocus;
      exit;
    end;
  if Edit3.Text='' then
    begin
      Application.MessageBox('Не заполнено поле: Отчество','Ошибка ввода',MB_OK);
      Edit3.SetFocus;
      exit;
    end;
